...
from .assessment_bank_v2 import ASSESSMENT_VERSION, POST_QUESTIONS_V2, POST_QUESTIONS_V3, PRE_QUESTIONS_V2, PRE_QUESTIONS_V3
...
QUESTION_BANKS = {
    ...
    "v0.4-test-2": {"pre": PRE_QUESTIONS_V2, "post": POST_QUESTIONS_V2},
    ASSESSMENT_VERSION: {"pre": PRE_QUESTIONS_V3, "post": POST_QUESTIONS_V3},
}
